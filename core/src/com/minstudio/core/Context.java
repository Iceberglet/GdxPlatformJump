...
public class Context {
    ...
    public static float G = -0.05f; //downwards

    public static float MAX_DOWNWARD_SPEED = -0.09f;

    public static float YOSHI_HORIZONTAL_SPEED = 0.075f;

    public static float YOSHI_JUMP_SPEED = 0.09f;

    private Collection<GameObject> gameObjects;

    private Collection<GameObject> hardObjects; //platforms that become
